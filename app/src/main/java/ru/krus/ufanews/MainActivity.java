...
import ru.krus.ufanews.News;
import ru.krus.ufanews.R;

public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
    public Elements content;
    public ArrayList<News> news = new ArrayList<ru.krus.ufanews.News>();
    ru.krus.ufanews.NewsAdapter adapter;
    public ArrayList<Afisha> afishas = new ArrayList<Afisha>();
    ru.krus.ufanews.AfishaAdapter adapter_afisha;
    private ListView lv;
            ...
            if (doc != null)
            {
                ...
                for (Element contents: content){
                    if (contents.select("h3[class=c-news-n-card__h]").text() != "") {
                        news.add(new ru.krus.ufanews.News(contents.select("h3[class=c-news-n-card__h]").text(),
            ...
            if (doc != null)
            {
                ...
                for (Element contents: content){
                    if (contents.select("div[class=js-grid-news-content]").text() != "") {
                        ...
                        afishas.add(new ru.krus.ufanews.Afisha(contents.select("h3[class=c-news-card__header]").text(),
    ...
    public void NewsParse(){
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                newThread.execute();
                adapter = new ru.krus.ufanews.NewsAdapter(MainActivity.this, news);
            }
        });
        ...
        NewThread newThread = new NewThread();
        newThread.execute();
        adapter = new ru.krus.ufanews.NewsAdapter(this, news);

        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                      @Override
                                      public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                                          Intent intent = new Intent(MainActivity.this, ru.krus.ufanews.NewsDetailed.class);
    ...
    public void AfishaParse(){
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                newThreadA.execute();
                adapter_afisha = new ru.krus.ufanews.AfishaAdapter(MainActivity.this, afishas);
            }
        });
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                      @Override
                                      public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                                          Intent intent = new Intent(MainActivity.this, ru.krus.ufanews.AfishaDetailed.class);
